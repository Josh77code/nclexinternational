      ...
      <main className="flex-1 pt-24">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="mx-auto max-w-5xl text-center space-y-6">
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white border border-[#0A61C9]/20">
              <Sparkles className="h-4 w-4 text-[#0A61C9]" />
              <span className="text-sm font-semibold text-[#0A61C9] tracking-wide">OUR PACKAGES</span>
            </div>
            <h1 className="text-4xl sm:text-5xl font-bold text-balance">Tailored NCLEX Pathways for Every Nurse</h1>
            <p className="text-xl text-[#0A61C9] text-pretty max-w-3xl mx-auto">
          ...
          <div className="mx-auto max-w-6xl space-y-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {packages.map((pkg) => (
                <Card
                  key={pkg.name}
                  className="flex flex-col bg-white hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-2 border-[#749DC8] hover:border-[#749DC8]"
                >
                  <CardHeader className="space-y-4 pb-0">
                    <div className="flex items-center justify-between gap-4">
                      <CardTitle className="text-2xl font-bold text-[#0A61C9]">{pkg.name}</CardTitle>
                      <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[#0A61C9]/15 to-[#0A61C9]/20 text-[#0A61C9]">
                        <pkg.icon className="h-6 w-6" />
                      </div>
                    </div>
                    <p className="text-[#0A61C9] text-sm leading-relaxed">{pkg.summary}</p>
                  </CardHeader>
                  <CardContent className="flex-1 pt-6">
                    <ul className="space-y-3 text-sm text-[#0A61C9]">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="p-6 bg-white rounded-lg shadow-sm border-2 border-[#749DC8] hover:border-[#749DC8] transition-all duration-300">
                <h3 className="font-semibold text-lg mb-2">Strategic Video Lectures</h3>
                <p className="text-[#0A61C9] text-sm">
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#0A61C9] text-white font-bold shrink-0">
                  1
                </div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#749DC8] text-white font-bold shrink-0">
                  2
                </div>
                <div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="mx-auto max-w-3xl text-center space-y-6">
            <h2 className="text-3xl font-bold text-[#0A61C9]">Ready for Your Personalised Quote?</h2>
            <p className="text-[#0A61C9] text-lg">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                className="w-full sm:w-auto bg-[#0A61C9] hover:bg-[#749DC8] text-white"
              ...
              <Button
                variant="outline"
                className="w-full sm:w-auto border-[#0A61C9] text-[#0A61C9] hover:bg-[#0A61C9]/10"
                asChild
              >
