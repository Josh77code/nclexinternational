      ...
      <main className="flex-1 pt-24">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 space-y-12 max-w-5xl mx-auto">
          <Card className="border-2 border-[#0A61C9]">
            <CardHeader>
              <CardTitle className="text-2xl text-[#0A61C9]">1. Introduction</CardTitle>
            </CardHeader>
          ...
          <Card className="border-2 border-[#0A61C9]">
            <CardHeader>
              <CardTitle className="text-2xl text-[#0A61C9]">2. General Policies</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
          ...
          <Card className="border-2 border-[#0A61C9]">
            <CardHeader>
              <CardTitle className="text-2xl text-[#0A61C9]">2a. General Classes</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
              <ul className="list-disc list-inside space-y-3">
          ...
          <Card className="border-2 border-[#0A61C9]">
            <CardHeader>
              <CardTitle className="text-2xl text-[#0A61C9]">2b. One-on-One Push</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
              <ul className="list-disc list-inside space-y-3">
          ...
          <Card className="border-2 border-[#0A61C9]">
            <CardHeader>
              <CardTitle className="text-2xl text-[#0A61C9]">2c. Payment Policy</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
              <ul className="list-disc list-inside space-y-3">
          ...
          <Card className="border-2 border-[#0A61C9]">
            <CardHeader>
              <CardTitle className="text-2xl text-[#0A61C9]">3. Return Policy</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
              ...
              <div>
                <p className="font-semibold text-[#0A61C9] mb-2">Terms & Conditions</p>
                <ul className="list-disc list-inside space-y-3">
          ...
          <Card className="border-2 border-[#0A61C9]">
            <CardHeader>
              <CardTitle className="text-2xl text-[#0A61C9]">4. Conclusion</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
